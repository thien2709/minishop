...
<body>
	<div class="header_link-wrap"
		...
		<h1 style="font-size: 1.6rem; margin-left: 16px;">Quản lý Account</h1>
	</div>
	<!-- <div class="container"> -->
						...
						<tr>
							...
							<td>
								<form action="admin" method="post">
									...
									<table>
										<tr>
											<td><label for="isSell">IsSell</label> <c:if
													test="${user.isSell == 1}">
													<input type="checkbox" name="isSell" checked="checked">
												</c:if> <c:if test="${user.isSell != 1}">
													<input type="checkbox" name="isSell">
												</c:if></td>
											<td><label for="enable">Enable</label> <c:if
													test="${user.enable == 1}">
